  ...
  return (
    <View style={styles.container}>
      ...
      >
              ...
              <View style={styles.heroInfoCard}>
                ...
                <View style={styles.cardContentInner}>
                  <View style={styles.heroHeader}>
                    <View style={{ flex: 1 }}>
                      <Text style={styles.monsterName}>Architect</Text>
                      <Text style={styles.tagline}>Helps you decide what to build, what to ignore, and how to not break along the way.</Text>
                    </View>
                  ...
                  <View style={styles.infoSection}>
                    ...
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoDesc}>life goal, constraints, time horizon, energy, focus</Text>
                    </View>
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoDesc}>priorities, tradeoffs, risk limits, next focus</Text>
                    </View>
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoDesc}>goal shifts, recurring limits, overload points, growth paths</Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.getSection}>
                    ...
                    <View style={styles.checkRow}>
                      ...
                      <Text style={styles.checkText}>Clearer priorities</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>Fewer overloaded plans</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>Better long-term decisions</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>More realistic paths forward</Text>
                    </View>
                  </View>
                </View>
              </View>
                ...
                <View style={styles.goalContentWrapper}>
                  <View style={styles.goalInnerContainer}>
                    ...
                    <Text style={[styles.goalText, !goal && styles.placeholderGoalText]}>
                      {goal || "Tell me what you’re trying to build or change."}
                    </Text>
                  </View>
                  <TouchableOpacity style={styles.ctaButton} onPress={() => router.push('/(tabs)/home')}>
                    <Text style={styles.ctaButtonText}>
                      {goal ? "Chat to edit" : "Set a life goal"}
                    </Text>
        ...
        {/* Life Strategy Profile Section */}
        <View style={styles.section}>
          <View style={styles.sectionHeaderRow}>
            <ClipboardList size={20} color="#000" style={styles.sectionIcon} />
            <Text style={styles.sectionTitle}>Your life strategy profile</Text>
          </View>
          
          <View style={styles.profileCard}>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Primary life goal</Text>
              {renderValue(profile.primaryLifeGoal)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Biggest constraint</Text>
              {renderValue(profile.biggestConstraint)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Time horizon</Text>
              {renderValue(profile.timeHorizon)}
            </View>
            <View style={styles.profileRow}>
            ...
            <View style={styles.profileRow}>
              ...
              {renderValue(profile.focusAreas)}
            </View>
            ...
            {Object.values(profile).some(v => v === null) && (
              ...
              >
                <Text style={styles.ctaButtonText}>Add your life info</Text>
                <ArrowRight size={18} color="#FFF" />
              </TouchableOpacity>
            )}
          </View>
