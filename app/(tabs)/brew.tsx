...
interface ProfileData {
  ...
  alcoholSensitivity: string | null;
  drinkTiming: string | null;
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.heroBannerContainer}>
          ...
          />
          <Image 
            source={{ uri: 'https://dzdbhsix5ppsc.cloudfront.net/monster/Brew.png' }} 
              ...
              <View style={styles.heroInfoCard}>
                ...
                <View style={styles.cardContentInner}>
                  <View style={styles.heroHeader}>
                    <View style={{ flex: 1 }}>
                      <Text style={styles.monsterName}>Brew</Text>
                      <Text style={styles.tagline}>Helps you enjoy coffee and drinks without hurting your sleep or body.</Text>
                    </View>
                  ...
                  <View style={styles.infoSection}>
                    ...
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoDesc}>caffeine sensitivity, alcohol sensitivity, drink timing, preferences</Text>
                    </View>
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoDesc}>timing fit, safe amount, better options, gentle warnings</Text>
                    </View>
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoDesc}>good reactions, bad reactions, next-day patterns, flavor tastes</Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.getSection}>
                    ...
                    <View style={styles.checkRow}>
                      ...
                      <Text style={styles.checkText}>Better energy after coffee or drinks</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>Fewer bad nights and hangovers</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>More enjoyable, mindful drinking</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>A better sense of what suits your body</Text>
                    </View>
                  </View>
                </View>
              </View>
                ...
                <View style={styles.goalContentWrapper}>
                  <View style={styles.goalInnerContainer}>
                    ...
                    <Text style={[styles.goalText, !goal && styles.placeholderGoalText]}>
                      {goal || "Tell me what you want to feel better about — coffee, alcohol, or both."}
                    </Text>
                  </View>
                  <TouchableOpacity style={styles.ctaButton} onPress={() => router.push('/(tabs)/home')}>
                    <Text style={styles.ctaButtonText}>
                      {goal ? "Chat to edit" : "Set a drink goal"}
                    </Text>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeaderRow}>
            ...
            <Text style={styles.sectionTitle}>Your drink profile</Text>
          </View>
          
          <View style={styles.profileCard}>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Caffeine sensitivity</Text>
              {renderValue(profile.caffeineSensitivity)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Alcohol sensitivity</Text>
              {renderValue(profile.alcoholSensitivity)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Drink timing</Text>
              {renderValue(profile.drinkTiming)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Preferred drinks</Text>
              {renderValue(profile.preferredDrinks)}
            </View>
            ...
            {Object.values(profile).some(v => v === null) && (
              ...
              >
                <Text style={styles.ctaButtonText}>Add your drink info</Text>
                <ArrowRight size={18} color="#FFF" />
              </TouchableOpacity>
            )}
          </View>
