...
export default function SomnoScreen() {
      ...
      >
              ...
              <View style={styles.heroInfoCard}>
                ...
                <View style={styles.cardContentInner}>
                  <View style={styles.heroHeader}>
                    <View style={{ flex: 1 }}>
                      <Text style={styles.monsterName}>Somno</Text>
                      <Text style={styles.tagline}>Helps you fall asleep on time and wake up with energy.</Text>
                    </View>
                  ...
                  <View style={styles.infoSection}>
                    ...
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoDesc}>bedtime, tonight’s plan, screens, sleep feel</Text>
                    </View>
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoDesc}>slow down, go to sleep, gentle nudges, small tweaks</Text>
                    </View>
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoDesc}>your rhythm, good nights, what helped, what blocked</Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.getSection}>
                    ...
                    <View style={styles.checkRow}>
                      ...
                      <Text style={styles.checkText}>On-time sleep guidance</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>Gentle bedtime nudges (not alarms)</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>Better energy the next day</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>Less revenge bedtime scrolling</Text>
                    </View>
                  </View>
                </View>
              </View>
                ...
                <View style={styles.goalContentWrapper}>
                  <View style={styles.goalInnerContainer}>
                    ...
                    <Text style={[styles.goalText, !goal && styles.placeholderGoalText]}>
                      {goal || "Tell me what you want to improve about your sleep."}
                    </Text>
                  </View>
                  <TouchableOpacity style={styles.ctaButton} onPress={() => router.push('/(tabs)/home')}>
                    <Text style={styles.ctaButtonText}>
                      {goal ? "Chat to edit" : "Set a sleep goal"}
                    </Text>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeaderRow}>
            ...
            <Text style={styles.sectionTitle}>Your sleep profile</Text>
          </View>
          
          <View style={styles.profileCard}>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Usual bedtime</Text>
              {renderValue(profile.usualBedtime)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Sleep duration</Text>
              {renderValue(profile.sleepDuration)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Sleep quality</Text>
              {renderValue(profile.sleepQuality)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Screen before bed</Text>
              {renderValue(profile.screenBeforeBed)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Wake consistency</Text>
              {renderValue(profile.wakeConsistency)}
            </View>
            ...
            {Object.values(profile).some(v => v === null) && (
              ...
              >
                <Text style={styles.ctaButtonText}>Add your sleep info</Text>
                <ArrowRight size={18} color="#FFF" />
              </TouchableOpacity>
            )}
          </View>
...
const styles = StyleSheet.create({
  ...
  characterCardContainer: {
    ...
    marginBottom: 24, // Space between card and next section
    zIndex: 10,
  },
  heroInfoCard: {
    flex: 1,
