    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.heroBannerContainer}>
          ...
          />
          <Image 
            source={{ uri: 'https://dzdbhsix5ppsc.cloudfront.net/monster/Fiscal.png' }} 
              ...
              <View style={styles.heroInfoCard}>
                ...
                <View style={styles.cardContentInner}>
                  <View style={styles.heroHeader}>
                    <View style={{ flex: 1 }}>
                      <Text style={styles.monsterName}>Fiscal</Text>
                      <Text style={styles.tagline}>Helps you understand money and make safer long-term decisions.</Text>
                    </View>
                  ...
                  <View style={styles.infoSection}>
                    ...
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoDesc}>income & spending, saving goals, risk comfort, interests</Text>
                    </View>
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoDesc}>focus now, risk alerts, knowledge gaps, key questions</Text>
                    </View>
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoDesc}>priorities, risk shifts, confusion points, long-term build</Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.getSection}>
                    ...
                    <View style={styles.checkRow}>
                      ...
                      <Text style={styles.checkText}>Clearer financial understanding</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>Fewer impulsive or risky decisions</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>A sense of direction with your money</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>Less anxiety around financial choices</Text>
                    </View>
                  </View>
                </View>
              </View>
                ...
                <View style={styles.goalContentWrapper}>
                  <View style={styles.goalInnerContainer}>
                    ...
                    <Text style={[styles.goalText, !goal && styles.placeholderGoalText]}>
                      {goal || "Tell me what you want your money to do for you."}
                    </Text>
                  </View>
                  <TouchableOpacity style={styles.ctaButton} onPress={() => router.push('/(tabs)/home')}>
                    <Text style={styles.ctaButtonText}>
                      {goal ? "Chat to edit" : "Set a financial goal"}
                    </Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.profileCard}>
            <View style={styles.profileRow}>
              ...
              {renderValue(profile.monthlyIncome)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Monthly spending</Text>
              {renderValue(profile.monthlySpending)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Saving goal</Text>
              {renderValue(profile.savingGoal)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Risk tolerance</Text>
              {renderValue(profile.riskTolerance)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Financial priority</Text>
              {renderValue(profile.financialPriority)}
            </View>
            ...
            {Object.values(profile).some(v => v === null) && (
              ...
              >
                <Text style={styles.ctaButtonText}>Add your financial info</Text>
                <ArrowRight size={18} color="#FFF" />
              </TouchableOpacity>
            )}
          </View>
