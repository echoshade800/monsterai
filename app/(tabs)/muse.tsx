    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.heroBannerContainer}>
          ...
          />
          <Image 
            source={{ uri: 'https://dzdbhsix5ppsc.cloudfront.net/monster/Muse.png' }} 
              ...
              <View style={styles.heroInfoCard}>
                ...
                <View style={styles.cardContentInner}>
                  <View style={styles.heroHeader}>
                    <View style={{ flex: 1 }}>
                      <Text style={styles.monsterName}>Muse</Text>
                      <Text style={styles.tagline}>Helps you understand your relationships and feel less alone in them.</Text>
                    </View>
                  ...
                  <View style={styles.infoSection}>
                    ...
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoDesc}>relationship status, emotional load, conflict style, support network</Text>
                    </View>
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoDesc}>emotional meaning, better response, timing (speak / wait / ask), self-care</Text>
                    </View>
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoDesc}>repeating patterns, hard & good moments, emotional needs, safety signals</Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.getSection}>
                    ...
                    <View style={styles.checkRow}>
                      ...
                      <Text style={styles.checkText}>Clearer understanding of your relationships</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>Less self-blame and confusion</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>More grounded emotional decisions</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>A sense that you're not facing things alone</Text>
                    </View>
                  </View>
                </View>
              </View>
                ...
                <View style={styles.goalContentWrapper}>
                  <View style={styles.goalInnerContainer}>
                    ...
                    <Text style={[styles.goalText, !goal && styles.placeholderGoalText]}>
                      {goal || "Tell me what you want to feel or change in your relationships."}
                    </Text>
                  </View>
                  <TouchableOpacity style={styles.ctaButton} onPress={() => router.push('/(tabs)/home')}>
                    <Text style={styles.ctaButtonText}>
                      {goal ? "Chat to edit" : "Set a relationship goal"}
                    </Text>
        ...
        {/* Relationship Profile Section */}
        <View style={styles.section}>
          <View style={styles.sectionHeaderRow}>
            <ClipboardList size={20} color="#000" style={styles.sectionIcon} />
            <Text style={styles.sectionTitle}>Your relationship profile</Text>
          </View>
          
          <View style={styles.profileCard}>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Relationship status</Text>
              {renderValue(profile.relationshipStatus)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Emotional load</Text>
              {renderValue(profile.emotionalLoad)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Conflict pattern</Text>
              {renderValue(profile.conflictPattern)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Support network</Text>
              {renderValue(profile.supportNetwork)}
            </View>
            ...
            {Object.values(profile).some(v => v === null) && (
              ...
              >
                <Text style={styles.ctaButtonText}>Add your relationship info</Text>
                <ArrowRight size={18} color="#FFF" />
              </TouchableOpacity>
            )}
          </View>
