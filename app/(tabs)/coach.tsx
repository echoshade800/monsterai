    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.heroBannerContainer}>
          ...
          />
          <Image 
            source={{ uri: 'https://dzdbhsix5ppsc.cloudfront.net/monster/Coach.png' }} 
              ...
              <View style={styles.heroInfoCard}>
                ...
                <View style={styles.cardContentInner}>
                  <View style={styles.heroHeader}>
                    <View style={{ flex: 1 }}>
                      <Text style={styles.monsterName}>Coach</Text>
                      <Text style={styles.tagline}>Helps you move just enough — not too much, not too little.</Text>
                    </View>
                  ...
                  <View style={styles.infoSection}>
                    ...
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoDesc}>movement, frequency, energy, limits</Text>
                    </View>
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoDesc}>move more, rest, today’s dose, gentle nudges</Text>
                    </View>
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoDesc}>good days, tired days, mood patterns, favorite moves</Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.getSection}>
                    ...
                    <View style={styles.checkRow}>
                      ...
                      <Text style={styles.checkText}>Just-right movement guidance</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>Less guilt, more consistency</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>Better energy through the day</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>Fewer injuries and burnout</Text>
                    </View>
                  </View>
                </View>
              </View>
                ...
                <View style={styles.goalContentWrapper}>
                  <View style={styles.goalInnerContainer}>
                    ...
                    <Text style={[styles.goalText, !goal && styles.placeholderGoalText]}>
                      {goal || "Tell me what you want to improve about your activity."}
                    </Text>
                  </View>
                  <TouchableOpacity style={styles.ctaButton} onPress={() => router.push('/(tabs)/home')}>
                    <Text style={styles.ctaButtonText}>
                      {goal ? "Chat to edit" : "Set a movement goal"}
                    </Text>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeaderRow}>
            ...
            <Text style={styles.sectionTitle}>Your activity profile</Text>
          </View>
          
          <View style={styles.profileCard}>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Daily movement</Text>
              {renderValue(profile.dailyMovement)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Exercise frequency</Text>
              {renderValue(profile.exerciseFrequency)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Energy level</Text>
              {renderValue(profile.energyLevel)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Physical limits</Text>
              {renderValue(profile.physicalLimits)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Sitting time</Text>
              {renderValue(profile.sittingTime)}
            </View>
            ...
            {Object.values(profile).some(v => v === null) && (
              ...
              >
                <Text style={styles.ctaButtonText}>Add your activity info</Text>
                <ArrowRight size={18} color="#FFF" />
              </TouchableOpacity>
            )}
          </View>
