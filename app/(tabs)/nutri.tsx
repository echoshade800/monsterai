...
interface ProfileData {
  dailyCalorieNeed: string | null;
  currentWeight: string | null;
  eatingWindow: string | null;
  foodPreferences: string | null;
  triggerFoods: string | null;
}
...
export default function NutriScreen() {
  ...
  const fetchGoalTitle = useCallback(async () => {
    try {
      ...
      // 使用营养相关的 category，可以根据实际需求修改
      const category = 'nutritionist'; // 或者使用其他合适的 category
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.heroBannerContainer}>
          ...
          />
          <Image 
            source={{ uri: 'https://dzdbhsix5ppsc.cloudfront.net/monster/Nutri.png' }} 
              ...
              <View style={styles.heroInfoCard}>
                ...
                <View style={styles.cardContentInner}>
                  <View style={styles.heroHeader}>
                    <View style={{ flex: 1 }}>
                      <Text style={styles.monsterName}>Nutritionist</Text>
                      <Text style={styles.tagline}>Responsible for your daily eating decisions.</Text>
                    </View>
                  ...
                  <View style={styles.infoSection}>
                    ...
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoDesc}>meal descriptions, eating time, habits, context</Text>
                    </View>
                    <View style={styles.infoRow}>
                      <Text style={[styles.infoLabel, { color: '#F38319' }]}>Output <Text style={styles.infoSubLabel}>--</Text> <Text style={styles.infoSubLabel}>What I decide & suggest</Text></Text>
                      <Text style={styles.infoDesc}>balance, portions, timing, gentle interventions</Text>
                    </View>
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoDesc}>patterns, preferences, trigger foods, responses</Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.getSection}>
                    ...
                    <View style={styles.checkRow}>
                      ...
                      <Text style={styles.checkText}>Personalized eating guidance</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>Smart daily reminders</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>Long-term pattern understanding</Text>
                    </View>
                    <View style={styles.checkRow}>
                      <View style={styles.checkIcon}><Check size={12} color="#FFF" strokeWidth={3} /></View>
                      <Text style={styles.checkText}>Gentle behavior change</Text>
                    </View>
                  </View>
                </View>
              </View>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeaderRow}>
            ...
            <Text style={styles.sectionTitle}>Your nutrition profile</Text>
          </View>
          
          <View style={styles.profileCard}>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Daily calorie need</Text>
              {renderValue(profile.dailyCalorieNeed)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Current weight</Text>
              {renderValue(profile.currentWeight)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Eating window</Text>
              {renderValue(profile.eatingWindow)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Food preferences</Text>
              {renderValue(profile.foodPreferences)}
            </View>
            <View style={styles.profileRow}>
              <Text style={styles.profileLabel}>Trigger foods</Text>
              {renderValue(profile.triggerFoods)}
            </View>
            ...
            {Object.values(profile).some(v => v === null) && (
              ...
              >
                <Text style={styles.ctaButtonText}>Add your info</Text>
                <ArrowRight size={18} color="#FFF" />
              </TouchableOpacity>
            )}
          </View>
...
const styles = StyleSheet.create({
  ...
  characterCardContainer: {
    ...
    marginBottom: 24, // Increased space between character card and current goal
    zIndex: 10,
  },
  heroInfoCard: {
    flex: 1,
  ...
  monsterName: {
    ...
    color: '#E67E22',
    lineHeight: 38,
    paddingRight: 64, // Space for absolute badge
  },
  tagline: {
    fontSize: 14,
